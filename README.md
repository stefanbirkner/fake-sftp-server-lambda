...
or public key authentication. By default, the server accepts every pair of
username and password and every SSH key.

You can enforce authentication by registering credentials
